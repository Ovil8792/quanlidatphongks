...
window.addEventListener("load", function(){
  window.cookieconsent.initialise({
    ...
    content: {
      ...
      dismiss: "Đã hiểu",
      link: "Tìm hiểu thêm",
      href: "<?php echo e(route('client.privacy-policy')); ?>" // hoặc link đến trang chính sách của bạn
    }
  })
});
</script>
                    ...
                    <div class="col-lg-2">
                        <div class="logo">
                            <a href="<?php echo e(route("client.index")); ?>">
                                <img width="50%" src="<?php echo e(asset(url(""))); ?>/img/logo.png" alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="ft-about">
                            <div class="logo">
                                <a href="#">
                                    <img width="60%" src="<?php echo e(asset(url(""))); ?>/img/footer-logo.png" alt="">
                                </a>
                            </div>
        ...
        <div class="copyright-option">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <ul>
                            <li><a href="<?php echo e(route("client.contact")); ?>">Liên hệ</a></li>
                            <li><a href="#">Terms of use</a></li>
                            <li><a href="<?php echo e(route("client.privacy-policy")); ?>">Chính sách</a></li>
